    ...
    $("#reindeer").click(function () {
        ...
        if (bShowLetter == false) {
            $('#reindeer').animate({
                ...
                $("#letter").show("drop", { direction: "down" }, "slow");
                ...
                $('#reindeer').animate({
                    ...
                    $(".message").typed({
                        strings: [
                            "Dear Tester số 1 của emm,<br> Chúc chị năm mới vui vẻ, chúc chị và gia đình luôn mạnh khoẻ, bình an; vạn sự như ý, triệu sự như mơ, tỷ sự bất ngờ và hàng ngàn niềm hạnh phúc!!<pre>        From Đại ca of u &#10084;</pre>"
                        ],
                        typeSpeed: 50,
                        startDelay: 500,
                        backSpeed: 100,
